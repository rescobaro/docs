...
=== Custom Fields
Overlay supports adding custom fields in addition to username and password.
Custom fields are shown above the "Submit" button.
Use `name` attribute to ensure custom field `value` gets submitted with the form.
...
[source,typescript]
----
include::{root}/frontend/demo/component/login/login-overlay-custom-field-preview.ts[render,group=TypeScript]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/login/react/login-overlay-custom-field-preview.ts[render,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/login/login-overlay-custom-field.ts[tags=snippet,indent=0,group=TypeScript]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/login/LoginOverlayCustomField.java[tags=snippet,indent=0,group=Java]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/login/react/login-overlay-custom-field.tsx[tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[role="since:com.vaadin:vaadin@V24.2"]
=== Footer
Footer can be used for placing additional custom content, such as text, buttons, etc.
Adding components after the overlay is opened is not supported.
